...
| Conoce los puntos requeridos de éste documento sobre un sector empresarial | Raúl Quispe Erasmo:<br> *TB1:* En este ciclo de mi carrera, aprendí sobre las aplicaciones web y fortaleciendo el conocimiento sobre .NET, .NET Framework, Html y CSS para este proyecto <br>*TB2:* ... | Su texto de conclusión |
